...
vendor_list=('chipone' 'fpc')
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpsensor_spi_tee.ko" "/vendor/lib/modules/$GKI_PATH/fpc1020_mmi.ko")
kernel_so_name_list=("fpsensor_spi_tee.ko" "fpc1020_mmi.ko")
dev_node_list=("/dev/fpsensor" "/sys/class/fingerprint/fpc1020/irq")
hal_list=('chipone_fp_hal' 'fps_hal')
